...
public class UserRepository {
	...
	public User findName(String name) {
		String sql = "select id,name,password from"+tabeleName + "WHERE name = :name";
	...
	private static final ResultSetExtractor<List<User>>  userListRowMapper = (rs) -> {
	...
	public List<User>  findByName(String name) {
		String sql ="select * from member WHERE name =:name ORDER BY id;";
		SqlParameterSource param = new MapSqlParameterSource().addValue("name", name);
		List <User>userList = jdbcTemplate.query(sql,param ,userListRowMapper);
		return userList;
	}
}